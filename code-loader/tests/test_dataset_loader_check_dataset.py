...
from tests.fixtures.dataset_loaders import no_cloud_dataset_loader, no_cloud_wt_visualizer_dataset_loader
from tests.fixtures.results.simple_no_cloud_dataset import no_cloud_dataset_loader_expected_result
from tests.fixtures.results.simple_no_cloud_wt_visualizer_dataset import no_cloud_wt_visualizer_dataset_loader_expected_result
...
@use_fixture(no_cloud_wt_visualizer_dataset_loader_expected_result)
